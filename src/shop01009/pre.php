<?php
// 現在アクセスしているユーザーのユーザーID($userId)とユーザー名($userName)を特定する // セッションからもクッキーからも取得できなかった場合は、仮のユーザーIDを発行する
...
// クッキーにもユーザーID、名前が保持されていないなら、8桁の乱数を発生させて仮のIDとしユーザー名はゲストとする // クッキーの有効期限は2週間とする
    } else {
